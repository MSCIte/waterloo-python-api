...
class Feature(BaseModel):
    ...
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default=None, description="Type of Feature")
    properties: Optional[Location] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "properties": Location.from_dict(obj.get("properties")) if obj.get("properties") is not None else None,
