...
class Path(BaseModel):
    ...
    pathauto: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["pid", "source", "alias", "language", "pathauto"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if pathauto (nullable) is None
        # and model_fields_set contains the field
        if self.pathauto is None and "pathauto" in self.model_fields_set:
            _dict['pathauto'] = None
