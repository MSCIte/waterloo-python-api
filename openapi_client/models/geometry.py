...
class Geometry(BaseModel):
    ...
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default=None, description="Type of geometry")
    coordinates: Optional[List[Union[StrictFloat, StrictInt]]] = Field(default=None, description="Latitude and Longitude collection of this location")
