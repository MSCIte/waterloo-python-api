...
class TitleField(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in en (list)
        _items = []
        if self.en:
            for _item in self.en:
                if _item:
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "en": [En.from_dict(_item) for _item in obj.get("en")] if obj.get("en") is not None else None
        })
        return _obj
