...
class Combo(BaseModel):
    ...
    image: Optional[ComboImage] = None
    options: Optional[StrictStr] = None
    item: Optional[StrictStr] = None
    price: Optional[StrictStr] = None
    calories: Optional[Any] = None
    __properties: ClassVar[List[str]] = ["name", "image", "options", "item", "price", "calories"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "image": ComboImage.from_dict(obj.get("image")) if obj.get("image") is not None else None,
