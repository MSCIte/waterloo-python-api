...
class LocationGeo(BaseModel):
    ...
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default=None, description="Type property of GEO JSON collection")
    features: Optional[List[Feature]] = Field(default=None, description="Features of this collection")
