...
class TestFoodServicesOutlet(unittest.TestCase):
    """FoodServicesOutlet unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FoodServicesOutlet:
        """Test FoodServicesOutlet
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FoodServicesOutlet`
        """
        model = FoodServicesOutlet()
        if include_optional:
    ...
    def testFoodServicesOutlet(self):
        """Test FoodServicesOutlet"""
